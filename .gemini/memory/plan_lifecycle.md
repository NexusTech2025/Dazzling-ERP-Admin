# Plan Lifecycle & Archival Policies

This document establishes the architectural standards for creating, updating, and categorizing implementation plans and walkthroughs within the `.gemini/` workspace directory.

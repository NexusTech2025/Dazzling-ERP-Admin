---
Date: 2026-07-05T18:38:00+05:30
Status: Verified
---
...
* **Integrated status toggles:**
  * **Course details:** Integrated `useUpdateCourseMutation` and `<StatusButton />` in [CourseDetails.jsx](file:///e:/NAST/Dazzling/ERP%20System/dazzling-erp-admin/src/features/course/CourseDetails.jsx).
  * **Package details:** Integrated `useUpdatePackageMutation` and `<StatusButton />` in [PackageDetails.jsx](file:///e:/NAST/Dazzling/ERP%20System/dazzling-erp-admin/src/features/course/PackageDetails.jsx).
  * **Batch details:** Integrated `useUpdateBatchMutation` and `<StatusButton />` in [BatchProfile.jsx](file:///e:/NAST/Dazzling/ERP%20System/dazzling-erp-admin/src/pages/admin/BatchProfile.jsx) and [BatchProfileHeader.jsx](file:///e:/NAST/Dazzling/ERP%20System/dazzling-erp-admin/src/features/batch/components/profile/BatchProfileHeader.jsx).

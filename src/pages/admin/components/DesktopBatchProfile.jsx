...
const DesktopBatchProfile = React.memo(({
  ...
  const tabRegistry = useMemo(() => ({
    ...
    Schedule: (
      <div className="py-20 text-center animate-in fade-in zoom-in-95 bg-surface-light dark:bg-surface-dark rounded-xl border border-border-light dark:border-border-dark shadow-sm">
        ...
        <h3 className="text-lg font-bold text-text-main dark:text-white">Schedule Section</h3>
  ...
  return (
    <div className="space-y-6 pb-10">
      ...
      {/* Internally instantiates the design system's TabGroup controls */}
      <BatchProfileHeader
        batch={batch}
        activeTab={activeTab}
...
DesktopBatchProfile.displayName = 'DesktopBatchProfile';
export default DesktopBatchProfile;

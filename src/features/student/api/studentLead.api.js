...
export const fetchStudentLeads = (token, filter = {}, options = {}) =>
  executeAction(API_REGISTRY.LEAD.QUERY, { target: 'StudentLead', where: filter }, token, { timeout: 'STANDARD', ...options });
...
export const fetchStudentLeadDetail = (token, id, options = {}) =>
  executeAction(API_REGISTRY.LEAD.QUERY, { target: 'StudentLead', where: { lead_id: id } }, token, { timeout: 'STANDARD', ...options });
...
export const updateStudentLead = (token, id, data, options = {}) =>
  executeAction(API_REGISTRY.LEAD.UPDATE, { target: 'StudentLead', id, data }, token, { timeout: 'DATA_MUTATION', ...options });
...
export const deleteStudentLead = (token, id, options = {}) =>
  executeAction(API_REGISTRY.LEAD.DELETE, { target: 'StudentLead', table: 'StudentLead', id }, token, { timeout: 'DATA_MUTATION', ...options });

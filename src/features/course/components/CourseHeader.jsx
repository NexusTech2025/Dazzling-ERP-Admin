  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
      <div className="flex flex-col gap-1">
        <h3 className="text-2xl font-black text-text-main dark:text-white tracking-tight">Curriculum</h3>
        <p className="text-sm text-text-secondary font-medium italic">Manage course offerings and academic programs</p>
      </div>
